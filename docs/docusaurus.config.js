...
(module.exports = {
  ...
  projectName: 'PIASO', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Fishell Lab @Harvard Medical School and Broad Institute. Built with Docusaurus.`,
      },
      prism: {
